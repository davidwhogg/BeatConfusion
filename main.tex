...
That is, you don't have to successfully optimize everything to be deemed successful here (and, indeed, to be publishable in the refereed literature).
...
\begin{problem}[fully profiled catalog]\label{prob:fullprofile}
...
In particular, it might deliver much better uncertainty estimates (more representative of the actual errors than what is returned by standard practice) on the well-detected stars.
\end{note}
...
Don't forget, though, that your model for a patch must include stars that are outside the bounds of the patch.
\end{problem}
...
I further conjecture that the thing that will be better, here and in \probref{prob:fullprofile}, than what one gets by standard practice, will be the \emph{uncertainty estimates} for the well-detected (bright) stars.
\end{note}
